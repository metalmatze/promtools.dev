...
class LatencyForm extends LitElement {
    ...
    constructor() {
        super();
        this.target = 100;
        this.metric = 'http_request_duration_seconds';
            ...
            <form @submit="${this.generate}">
                <div class="field">
                    <label class="label" for="target">
                        <h3>Latency Target (in ms)</h3>
                        <div class="control">
                            <input class="input" type="number" min="0" id="target"
                                placeholder="100"
                                autofocus
                                .value="${this.target}"
...
customElements.define('promtools-form-latency', LatencyForm);
