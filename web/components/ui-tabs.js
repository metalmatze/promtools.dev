    ...
    render() {
        ...
        return html`
            <div class="tabs">
                <ul>
                    <li>
                        <a class="${this.active === '/alerts/errors' ? 'active' : ''}" @click="${() => this.activate('/alerts/errors')}">
                            ${errors}
                            Errors
                        </a>
                    </li>
                    <li>
                        <a class="${this.active === '/alerts/latency' ? 'active' : ''}" @click="${() => this.activate('/alerts/latency')}">
                            ${latency}
                            Latency
                        </a>
                    </li>
